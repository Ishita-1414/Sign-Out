...
//@input SceneObject kb
//@input SceneObject fd1
//@input SceneObject fd2
//@input SceneObject fd3
...
//@input string symbolsCaps = "~`^\'\"\\[]{}$???8-=*/:;????v" {"showIf":"advanced"}
...
function togglePanel(){
	if(global.keyboard.isActive){
        ...
        script.fd1.enabled = true;
        script.fd2.enabled = true;
        script.fd3.enabled = true;
        script.kb.enabled = false;
	}else{
		if(script.controlTouchBlocking) global.touchSystem.touchBlocking = true;
		global.keyboard.isActive = true;
